import {defeatScreen1, defeatScreen2, defeatScreen3, victoryScreen1, victoryScreen2, victoryScreen3, checkFlipClass} from './main';

export function compare1(container: HTMLElement) {
	let hasFlipperedCard = false;
	let firstCard:string , secondCard:string;
