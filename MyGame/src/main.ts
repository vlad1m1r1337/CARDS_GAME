...
function renderMainScreenOpenCards1(container: HTMLElement) {
    ...
    divGameHead.classList.add("game-header")

    renderTaimer(divGameHead)

    const button = document.createElement("button")
    button.classList.add("button", "header-button")
    ...
    divCards.classList.add("div-cards")
...
function renderFirstPage(container: HTMLElement): void {
    ...
    h1.classList.add("chose-difficult")

    const divDif = document.createElement("div")
    divDif.classList.add("chose-difficult")
    ...
    div1.classList.add("chose-difficult-number")
    ...
    div2.classList.add("chose-difficult-number")
    ...
    div3.classList.add("chose-difficult-number")
...
;(<any>window).application.renderBlock(
    "first-page",
